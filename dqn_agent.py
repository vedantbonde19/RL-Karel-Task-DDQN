...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        self.t_step = 0
        self.t_tot = 0 # LR Decay total steps 
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        self.t_tot = self.t_tot + 1 ## LR Decay total steps

        #self.lr_decay(total_steps=self.t_tot) ## LR Decay 
    ...
    #def lr_decay(self, total_steps):
        #lr_new = LR * (1 - total_steps / 230000)
